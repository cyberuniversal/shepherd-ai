"""Ground a typed command or intent JSON against a Shepherd-AI map CSV."""
...
def main() -> None:
    ...
    source.add_argument("--command", help="Typed mission command to parse and ground.")
    source.add_argument("--intent-json", type=Path, help="Path to a JSON file containing an intent record.")
    parser.add_argument("--map", type=Path, default=DEFAULT_MAP, help="CSV map dataset path.")
    ...
    payload = {
        "metadata": {
            ...
            "note": "Week 3 deterministic grounding output; not a research benchmark.",
        },
