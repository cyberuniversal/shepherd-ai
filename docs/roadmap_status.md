...
| Week 6 | Computer vision integration | `src/shepherd_ai/vision.py`, `scripts/prepare_agriculture_vision_subset.py`, `scripts/validate_vision_manifest.py`, `scripts/run_yolo_detection.py` | `notebooks/Notebook6_Vision.ipynb` | Agriculture-Vision selected; no downloaded image manifest yet | Acquisition path implemented; full Week 6 blocked on user terms acceptance, download, manifest, and inference |
