...
| Week 6 | Computer vision integration | `src/shepherd_ai/vision.py`, `scripts/validate_vision_manifest.py`, `scripts/run_yolo_detection.py` | `notebooks/Notebook6_Vision.ipynb` | `datasets/aerial_images/README.md`; no licensed image manifest yet | Foundation started; full Week 6 blocked on dataset/manifest/inference |
