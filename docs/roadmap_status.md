...
| Week 6 | Computer vision integration | `src/shepherd_ai/vision.py`, `scripts/prepare_agriculture_vision_subset.py`, `scripts/validate_vision_manifest.py`, `scripts/run_yolo_detection.py` | `notebooks/Notebook6_Vision.ipynb` | Agriculture-Vision selected; licensed imagery remains outside Git | T4 smoke test recorded; segmentation label mapping, training, and held-out modified-mIoU evaluation remain |
