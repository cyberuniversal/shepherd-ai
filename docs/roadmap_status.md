...
| Week 6 | Computer vision integration | `src/shepherd_ai/vision.py`, `scripts/prepare_agriculture_vision_subset.py`, `scripts/validate_vision_manifest.py`, `scripts/validate_agriculture_vision_labels.py`, `scripts/run_yolo_detection.py` | `notebooks/Notebook6_Vision.ipynb` | Agriculture-Vision selected; licensed imagery remains outside Git | T4 smoke test and 2017 label mapping recorded; train/validation audit, training, and held-out modified-mIoU evaluation remain |
...
- Week 6 has a foundation only. Do not claim dataset-backed computer-vision
  performance yet.
