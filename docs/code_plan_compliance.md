...
| LP-43 | 7,500 five-variant cases before exclusions. | not implemented |
...
| LP-47 | Thirty clusters, five variants, three resource repetitions. | not implemented |
...
| DoD-54 | No hidden reference field enters a prompt. | not implemented or evaluated |
