...
% Overleaf-ready IEEE conference manuscript with self-contained figures.
...
\hypersetup{
  ...
  pdfauthor={Mohammed Alnuwaiser and Aishwarya Tomar}
}
...
\author{
\IEEEauthorblockN{Mohammed Alnuwaiser\IEEEauthorrefmark{1} and
Dr.~Aishwarya Tomar\IEEEauthorrefmark{2}}
\IEEEauthorblockA{\IEEEauthorrefmark{1}~ALBA7OOTH Research Lab}
\IEEEauthorblockA{\IEEEauthorrefmark{2}~Assistant Professor, Department of Electronics Engineering,\\
...
\begin{IEEEkeywords}
multi-UAV systems, natural-language planning, validation placement, failure
containment, static plan fidelity, local inference measurement
\end{IEEEkeywords}
...
The code, frozen protocols, raw checkpoints, processed tables, figures, and
run metadata are available in the public artifact snapshot at
\url{https://github.com/cyberuniversal/shepherd-ai/tree/8cc059c17f67b733e3e4fe07d2683f89434e8c88}.
