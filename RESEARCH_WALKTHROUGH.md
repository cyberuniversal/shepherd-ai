...
- Mission-command dataset scaffolding provides English/Arabic seed and 200+ row benchmark files, train/eval/holdout splits, and parser baseline reports before any model training starts.
