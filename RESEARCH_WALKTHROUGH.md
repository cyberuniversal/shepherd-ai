...
- Learned-parser research scaffolding can train a local nearest-ngram baseline artifact, prepare an optional PyTorch/transformer corpus, evaluate frozen splits, analyze parser failures, gate learned-artifact or transformer-model promotion, and serve predictions through strict bounded-intent adapters without live dispatch authority.
