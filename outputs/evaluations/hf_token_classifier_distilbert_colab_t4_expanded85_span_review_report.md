...
- Review queue: `outputs/evaluations/hf_token_classifier_distilbert_colab_t4_expanded85_span_review_queue.jsonl`
- Editable command file: `outputs/evaluations/hf_token_classifier_distilbert_colab_t4_expanded85_span_review_commands.txt`
...
Focus errors: `4`; token errors: `3`
Current gold span arguments: action='Survey', target='stadium entrances', action='report', target='areas of heavy crowding'
False negatives from model comparison: target='areas of heavy crowding'
False positives from model comparison: constraint='of', target='areas', target='heavy crowding'
...
False negatives from model comparison: constraint='into equal sections'
...
False negatives from model comparison: target='parking lot'
False positives from model comparison: location='parking', target='lot'

## human_cmd_030

Text: `Send whichever drone has the most battery to the greenhouse.`

Review fields: `constraint, count, location`
Focus errors: `1`; token errors: `7`
Current gold span arguments: action='Send', count='whichever drone has the most battery', location='greenhouse'
False negatives from model comparison: count='whichever drone has the most battery', location='greenhouse'
False positives from model comparison: constraint='has the most battery to the greenhouse', count='whichever drone'
...
False positives from model comparison: constraint='with the highest battery', count='the drone'
...
False negatives from model comparison: action='return'
False positives from model comparison: none
