...
Each future human record must contain:
...
overlap, adjudication status, and author/reviewer separation. It cannot prove
semantic label correctness or replace ethics and participant-consent review.
